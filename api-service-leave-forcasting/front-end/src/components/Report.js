...
const Report = () => {
  ...
  return (<div>
    <Box component="form" sx={{ '& > :not(style)': { m: 1, width: '25ch' }, '& .MuiTextField-root': { m: 1, width: '25ch' }, }} noValidate >
      <TextField style={{ left: "25%", top: "50px" }} id="org" label="Org" variant="outlined" onChange={handleOrgChange} />
      <TextField style={{ left: "25%", top: "50px" }} id="team" label="Team" variant="outlined" onChange={handleTeamChange} />
      ...
      <Button id="download" variant="contained" style={{ left: "25%", top: "60px" }} disabled>Download</Button>
    </Box>
