...
import {
    Accordion, AccordionDetails, AccordionSummary, Button, Checkbox, DateRangePicker,
    FormControlLabel, Grid, Icon, IconButton, MenuItem, TextField, Typography
...
const MonthlyLeaveList = (props: MonthlyLeaveListProps) => {
    const { leaves, onMonthVisibiltyChange, onPlanChange, onLeaveDateChange, onLeaveAddition, onLeaveRemoval, onLeaveDateSpanChange } = props;
                                                    ...
                                                    <>
                                                        {
                                                            monthDetails.dateList.map((leavesDates, index: number) => (
                                                                <Grid item xs={12} key={index}>
                                                                    <Grid container spacing={2} alignItems="center">
                                                                        <Grid item xs={leavesDates.isEditable ? 9 : 12} sm={leavesDates.isEditable ? 10 : 12} md={6}>
                                                                            <DateRangePicker
                                                                                size="small"
                                                                ...
                                                                <Grid container spacing={2} alignItems="center">
                                                                    <Grid item xs={12}>
                                                                        <Button
                                                                            ...
                                                                            color="primary"
                                                                            variant="outlined"
                                                                            onClick={() => onLeaveAddition(month, monthDetails.dateList.length)}
