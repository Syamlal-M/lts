...
import {
  LeaveSummaryQueryParams,
  LeaveSummaryResponse
} from "types/api/employee/LeaveSummary.types";
...
const PlanningPage = () => {
  ...
  const updateLeave = useCallback(
    (params: UpdateLeaveQueryParams, leaveList: UpdateLeaveRequest) => {
  ...
  return (
    <PageContainer title="LTS | Leave Forecast">
      ...
      <LeaveSubmissionDialog
        ...
        leaveSummary={leaveSummaryList.find(
